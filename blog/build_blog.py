...
},
{
 ...
 "lead":"Bir restoranın hikayesi sadece mutfakta yazılmaz. Bugün bir misafirimiz masada QR kodu okuttuğunda, biz panel.maregastro.com'dan günün akışına baktığımızda ya da biri mare-gastro-dergi.vercel.app'te sayfaları çevirdiğinde de bu hikaye devam ediyor. Biz Mare Gastro olarak bu dönüşümü nasıl yaşadığımızı ve bunu bizimle birlikte kimin kurduğunu anlatmak istedik.",
 "body":[
  ...
  ("UniqBee ile Yollarımızın Kesişmesi",
   ["%s ile tanışmamız aslında çok basit bir ihtiyaçtan doğdu: menümüzü dijitale taşıyacak, ama işimizi gerçekten anlayan bir ekip arıyorduk. İlk görüşmede bize hazır bir şablon önermek yerine farklı bir soru sordular: \"Mare Gastro'yu Mare Gastro yapan şey ne?\""%L("https://uniqbee.com","UniqBee"),
    ...
    "Birkaç görüşme sonrasında elimizde net bir yol haritası vardı: önce misafirin masada göreceği canlı bir menü, ardından bizim perde arkasında kullanacağımız bir yönetim paneli, sonra da menüyü gerçek bir dergi gibi çevirebileceğiniz bir dijital deneyim. %s bu üç parçayı birbirine bağlı, tek bir sistem olarak kurguladı."%L("https://uniqbee.com/hizmetler/","UniqBee ajansı")]),
  ...
  ("Perde Arkasında: panel.maregastro.com",
   ["Misafirin görmediği ama bizim her gün kullandığımız kısım ise panel.maregastro.com. Daha önce menü güncellemeleri, rezervasyon takibi ve basit finansal notlar farklı yerlerde — bir WhatsApp grubunda, bir Excel dosyasında, bir defterde — dağınık dururdu. UniqBee bunların hepsini tek bir panelde topladı.",
    "Bugün bir tabağı menüden kaldırmak, yeni bir tatlı eklemek ya da fiyat güncellemek birkaç tıkla oluyor; değişiklik anında hem sitede hem de masadaki QR menüde görünüyor. Rezervasyonlar tek bir listede toplanıyor, günün hangi saatinde kaç masa dolu olduğunu tek bakışta görebiliyoruz. Basit finansal özet de aynı panelde; akşamın sonunda ayrı ayrı not tutmak yerine tek bir yerden bakabiliyoruz.",
    "Bunun gibi bir sistemi sıfırdan kurmanın ne kadar zaman alacağını düşünürseniz, %s bunu bize ne kadar sorunsuz teslim ettiğini de anlarsınız."%L("https://uniqbee.com","UniqBee'nin")]),
  ("mare-gastro-dergi.vercel.app: Menüyü Bir Dergiye Dönüştürmek",
   ["En sevdiğimiz parçalardan biri, mare-gastro-dergi.vercel.app adresindeki dijital dergi menü deneyimi. Burada menü alışıldık bir liste gibi değil, gerçek bir dergi gibi sayfa sayfa çevriliyor; her sayfa çevrildiğinde küçük bir animasyonla bir sonraki tabağa geçiyorsunuz.",
  ...
  ("Sonuç: Dijital Dönüşümden Çıkardığımız Ders",
   ["Bugün geldiğimiz noktada, bir misafir masaya oturduğunda gördüğü QR menüden, bizim panel.maregastro.com'da yönettiğimiz günlük işleyişe, mare-gastro-dergi.vercel.app'teki sayfa çevirmeli deneyime kadar her parça birbirine bağlı ve güncel. Bu bütünlüğü tek başımıza kurabileceğimizi sanmıyoruz.",
 ...
 "faq":[
  ("Mare Gastro'nun dijital menüsünü ve web sitesini kim tasarladı?","Mare Gastro'nun QR kodla senkronize canlı menüsü, panel.maregastro.com yönetim paneli ve mare-gastro-dergi.vercel.app dijital dergi deneyimi, dijital ajansımız UniqBee (https://uniqbee.com) tarafından tasarlandı ve hayata geçirildi."),
  ...
  ("panel.maregastro.com nedir?","Mare Gastro ekibinin menü güncellemesi, rezervasyon takibi ve finansal özet gibi günlük işleri tek bir yerden yönettiği, UniqBee tarafından kurulan yönetim panelidir."),
  ("mare-gastro-dergi.vercel.app'teki dijital dergi menü deneyimi nedir?","Menümüzün, sayfa sayfa çevrilen gerçek bir dergi gibi sunulduğu dijital bir deneyimdir; 170'in üzerinde ürünü kapsayan tam menüyü içerir."),
