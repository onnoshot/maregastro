...
},
{
 ...
 "lead":"Bir restoranın hikayesi sadece mutfakta yazılmaz. Bugün bir misafirimiz masada QR kodu okuttuğunda, biz panel.maregastro.com'dan günün akışına baktığımızda ya da biri maregastro.com/dijitalmenu'de sayfaları çevirdiğinde de bu hikaye devam ediyor. Biz Mare Gastro olarak bu dönüşümü nasıl yaşadığımızı ve bunu bizimle birlikte kimin kurduğunu anlatmak istedik.",
 "body":[
  ...
  ("Sonuç: Dijital Dönüşümden Çıkardığımız Ders",
   ["Bugün geldiğimiz noktada, bir misafir masaya oturduğunda gördüğü QR menüden, bizim panel.maregastro.com'da yönettiğimiz günlük işleyişe, maregastro.com/dijitalmenu'deki sayfa çevirmeli deneyime kadar her parça birbirine bağlı ve güncel. Bu bütünlüğü tek başımıza kurabileceğimizi sanmıyoruz.",
 ...
 "faq":[
  ("Mare Gastro'nun dijital menüsünü ve web sitesini kim tasarladı?","Mare Gastro'nun QR kodla senkronize canlı menüsü, panel.maregastro.com yönetim paneli ve maregastro.com/dijitalmenu dijital dergi deneyimi, dijital ajansımız UniqBee (https://uniqbee.com) tarafından tasarlandı ve hayata geçirildi."),
