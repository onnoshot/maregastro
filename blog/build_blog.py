...
},
{
 ...
 "desc":"Yıl dönümü, evlilik teklifi ya da özel bir akşam için Sapanca'da romantik akşam yemeği: gölün hemen yanındaki Mare Gastro'da unutulmaz bir deneyim.",
...
},
{
 ...
 "desc":"Sapanca'da ne yenir, nerede yemek yenir? Göl manzarası ve deniz ürünlerinden gurme bir hafta sonuna, Sapanca yemek rehberi ve Mare Gastro önerileri.",
...
},
{
 ...
 "title":"Sapanca'da Evlilik Teklifi Mekanı | Mare Gastro",
 "desc":"Sapanca'da unutulmaz bir evlilik teklifi mi planlıyorsunuz? Gölün hemen yanındaki romantik masa ve fine dining menüyle Mare Gastro'da hayalinizdeki anı yaşayın.",
...
},
{
 ...
 "desc":"Maşukiye, Kartepe ve göl kıyısını kapsayan bir Sapanca hafta sonu rotası: gün gün gezi planı ve Mare Gastro'da gölün hemen yanında bir akşam yemeği.",
...
},
{
 ...
 "desc":"Sapanca'da kışın sıcak bir gurme deneyimi mi arıyorsunuz? Gölün hemen yanındaki Mare Gastro'da kış atmosferi ve huzurlu bir akşam sizi bekliyor.",
...
},
{
 ...
 "desc":"Yeni yıla Sapanca'da gölün hemen yanında girin. Mare Gastro'da yılbaşı atmosferi, fine dining menü ve dingin bir kutlama için erken rezervasyon önerilir.",
...
},
{
 ...
 "desc":"Sapanca'da gölün hemen yanında bir rakı-balık sofrası nasıl kurulur? Doğru meze seçimi ve Mare Gastro'nun Ege esintili önerileriyle eksiksiz bir rehber.",
...
},
{
 ...
 "title":"Sapanca'da Gece Açık Restoran | Mare Gastro",
 "desc":"Sapanca'da gece geç saatte açık restoran mı arıyorsunuz? Didi Otel bahçesinde Cuma–Pazar 24 saat hizmet veren Mare Gastro'da gölün hemen yanında bir sofra.",
...
},
{
 ...
 "desc":"Sapanca'da doğum günü, kutlama veya sürpriz mi planlıyorsunuz? Gölün hemen yanındaki Mare Gastro'da özel masa ve imza tatlılarla unutulmaz bir gün.",
...
},
{
 ...
 "title":"Şef Doğan Anapa Kimdir? | Mare Gastro",
...
},
{
 ...
 "img":"mare-ambiance.webp","alt":"Bahçede akşam ışıkları — Sapanca'da yazın açık hava restoranı Mare Gastro",
...
},
{
 ...
 "title":"Sapanca'da Fine Dining Fiyat Rehberi | Mare Gastro",
...
},
{
 ...
 "body":[
  ...
  ("İhtiyacınıza Göre Kurumsal Rehberler",
   ["Şirketinizin etkinlik türüne göre hazırladığımız detaylı rehberlere göz atabilirsiniz:",
    "<ul><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li></ul>"%(
      L(post_url("sapanca-kurumsal-etkinlik-en-iyi-mekanlar"),"Sapanca'da kurumsal etkinlik için en iyi mekanlar"),
      L(post_url("sapanca-toplanti-sonrasi-aksam-yemegi"),"Toplantı sonrası akşam yemeği"),
      L(post_url("sapanca-istanbula-yakin-sirket-etkinligi-mekani"),"İstanbul'a yakın şirket etkinliği mekanı"),
      L(post_url("sapanca-toplu-organizasyon-grup-yemegi"),"Toplu organizasyon ve grup yemeği"),
      L(post_url("sapanca-yil-sonu-sirket-yemegi-ve-kutlama"),"Yıl sonu şirket yemeği ve kurumsal kutlama"))]),
 ],
 "faq":[
 ...
 "rel":["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-toplu-organizasyon-grup-yemegi","sapanca-istanbula-yakin-sirket-etkinligi-mekani"],
},
{
 "slug":"sapanca-kurumsal-etkinlik-en-iyi-mekanlar",
 "cat":"kurumsal","date":"2026-09-06","read":"7 dk",
 "img":"mare-teras-misafir.webp","alt":"Terasta ağırlanan misafirler — Sapanca'da kurumsal etkinlik mekanları karşılaştırması Mare Gastro",
 "h1":"Sapanca'da <em>Kurumsal Etkinlik</em> İçin En İyi Mekanlar: Karşılaştırmalı Rehber",
 "title":"Sapanca Kurumsal Etkinlik Mekanları | Mare Gastro",
 "desc":"Sapanca'da şirket yemeği veya kurumsal davet için en iyi mekan hangisi? Mare Gastro, NG Sapanca, Menzara, Sunday Restaurant ve Vital Göl'ü karşılaştırdık.",
 "kw":"sapanca kurumsal etkinlik mekanları, sapanca şirket yemeği, sapanca kurumsal davet mekanı, sapanca toplantı salonu, sapanca bayi toplantısı mekanı",
 "lead":"\"Sapanca'da kurumsal etkinlik için en iyi mekan hangisi?\" sorusunun tek bir cevabı yok — aranan deneyime göre değişiyor. Bölgenin kurumsal davetlere hizmet veren öne çıkan adreslerini mutfak kalitesi, kapasite ve atmosfer açısından karşılaştırdık.",
 "body":[
  ("Sapanca'da Kurumsal Etkinlik İçin Mekan Seçerken Neye Bakılır?",
   ["Sapanca'daki kurumsal etkinlik mekanları büyük ölçüde iki kategoride toplanıyor: geniş toplantı salonlu oteller ve temelde düğün/davet organizasyonu için tasarlanmış çok amaçlı salonlar. Doğru mekanı seçerken şu kriterler öne çıkıyor:",
    "<ul><li><strong>Mutfak kalitesi</strong> — banket usulü standart bir servis mi, yoksa gerçek bir şef mutfağı mı?</li><li><strong>Kapasite ve esneklik</strong> — küçük bir yönetim toplantısından kalabalık bir bayi organizasyonuna kadar uyum sağlıyor mu?</li><li><strong>Atmosfer</strong> — davet salonu havası mı, yoksa doğayla iç içe zarif bir sofra mı?</li><li><strong>Ulaşım ve otopark</strong> — İstanbul'a yakınlık ve geniş otopark imkânı var mı?</li><li><strong>Kurumsal güvence</strong> — bilinen, güvenilir bir işletme bünyesinde mi faaliyet gösteriyor?</li></ul>",
    "Bu kriterlere göre, Sapanca'da kurumsal davetlere hizmet veren beş adresi karşılaştırdık."]),
  ("Gerçek Bir Fine Dining Sofrası Arayanlar İçin: Mare Gastro",
   ["Didi Otel bahçesinde, gölün hemen kıyısında yer alan Mare Gastro; Yönetici Şef Doğan Anapa imzasıyla Ege ve Akdeniz mutfağını fine dining bir sunumla buluşturuyor. Bölgede kurumsal davetleri banket usulü standart bir menüyle değil, gerçek bir şef mutfağıyla karşılayan az sayıdaki adresten biri.",
    bfig("mare-bahce-manzarasi.webp","Didi Otel bahçesinden Mare Gastro'nun genel görünümü — Sapanca kurumsal etkinlik mekanı","Mare Gastro'nun Didi Otel bahçesindeki konumu"),
    "%s ve gölü karşınıza alan sakin bir masa, kurumsal bir davete hak ettiği ciddiyeti katan iki temel unsur."%L(MENU,"Mevsimsel à la carte menü")]),
  ("Büyük Toplantı Salonu ve Teknolojik Altyapı Arayanlar İçin: NG Sapanca Hotels",
   ["Farklı büyüklükte modern toplantı salonları ve teknolojik altyapısıyla NG Sapanca, konferans ve büyük ölçekli kurumsal toplantılar için tercih edilen bir otel işletmesi. Toplantı sonrası aynı tesiste akşam yemeği düzenlemek isteyen ekipler için pratik bir seçenek."]),
  ("Göl Manzaralı Bir Kurumsal Davet İçin: Menzara Restaurant",
   ["Sapanca Gölü manzarasına sahip balkonuyla bilinen Menzara Restaurant, kurumsal etkinlikler ve bayi toplantıları dahil geniş bir davet yelpazesine hizmet veriyor. Karadeniz ağırlıklı mutfağı, daha samimi ve yöresel bir kurumsal sofra arayanlar için değerlendirilebilir."]),
  ("Modern ve Ferah Bir Salon Arayanlar İçin: Sunday Restaurant",
   ["Sunday Restaurant, modern ve ferah salonlarıyla kurumsal davet ve özel toplantılara ev sahipliği yapan mekanlardan biri. Düğün ve kutlama organizasyonlarının yanında kurumsal etkinlikleri de kapsayan çok amaçlı bir yapı sunuyor."]),
  ("Geniş Kapasiteli Bayi Toplantısı İçin: Vital Göl Sapanca",
   ["Vital Göl Sapanca, bayi toplantısı ve kurumsal etkinlikler dahil geniş bir organizasyon yelpazesine hizmet veren bir davet mekanı. Kalabalık ve çok amaçlı organizasyonlar için değerlendirilebilecek adreslerden."]),
  ("Sonuç: Hangi Mekan Sizin Etkinliğiniz İçin Doğru?",
   ["Gölün hemen yanında, gerçek bir fine dining kalitesiyle geçecek bir kurumsal davet için %s listedeki en eksiksiz seçenek; büyük ölçekli konferans ve toplantı altyapısı için NG Sapanca Hotels; göl manzaralı yöresel bir sofra için Menzara; modern ve ferah bir salon için Sunday Restaurant; geniş kapasiteli bir bayi toplantısı için Vital Göl Sapanca tercih edilebilir."%L(REZ,"Mare Gastro"),
    "Etkinliğinizin niteliğine göre %s ve %s yazılarımıza da göz atabilirsiniz."%(L(post_url("sapanca-toplu-organizasyon-grup-yemegi"),"toplu organizasyon rehberimize"),L(post_url("sapanca-istanbula-yakin-sirket-etkinligi-mekani"),"İstanbul'a yakın şirket etkinliği yazımıza"))]),
 ],
 "faq":[
  ("Sapanca'da kurumsal etkinlik için en iyi mekan hangisi?","Bu, etkinliğinizin niteliğine göre değişir. Gerçek bir fine dining deneyimi için Mare Gastro, büyük ölçekli konferans ve toplantı altyapısı için NG Sapanca Hotels, göl manzaralı yöresel bir sofra için Menzara Restaurant öne çıkan seçeneklerdir."),
  ("Sapanca'da büyük toplantı salonu olan bir otel var mı?","Evet, NG Sapanca Hotels farklı büyüklükte modern toplantı salonları ve teknolojik altyapısıyla büyük ölçekli kurumsal toplantılara hizmet veriyor."),
  ("Mare Gastro kurumsal davetleri banket usulü mü karşılıyor?","Hayır. Mare Gastro, kurumsal davetlerde de Yönetici Şef Doğan Anapa imzalı à la carte fine dining menüsünü sürdürüyor; standart bir banket servisi sunmuyor."),
  ("Bayi toplantısı gibi kalabalık organizasyonlar için hangi mekanlar uygun?","Vital Göl Sapanca ve Sunday Restaurant, bayi toplantısı ve kalabalık kurumsal organizasyonlar için geniş salon kapasitesi sunan mekanlar arasında."),
 ],
 "rel":["sapanca-is-yemegi-kurumsal-davet","sapanca-toplu-organizasyon-grup-yemegi","sapanca-istanbula-yakin-sirket-etkinligi-mekani"],
},
{
 "slug":"sapanca-toplanti-sonrasi-aksam-yemegi",
 "cat":"kurumsal","date":"2026-09-07","read":"5 dk",
 "img":"mare-sofra-detay.webp","alt":"Özenle hazırlanmış sofra detayı — Sapanca'da toplantı sonrası akşam yemeği Mare Gastro",
 "h1":"Sapanca'da <em>Toplantı Sonrası</em> Akşam Yemeği İçin Nereye Gidilir?",
 "title":"Sapanca'da Toplantı Sonrası Restoran | Mare Gastro",
 "desc":"Sapanca'da iş toplantısı sonrası sakin, zarif bir akşam yemeği mi arıyorsunuz? Gölün hemen yanındaki Mare Gastro'yu keşfedin.",
 "kw":"sapanca toplantı sonrası restoran, toplantı sonrası yemek sapanca, sapanca iş görüşmesi sonrası mekan, sapanca akşam yemeği toplantı",
 "lead":"Uzun bir toplantı gününün ardından doğru bir sofra, günün yorgunluğunu keyifli bir kapanışa dönüştürür. Sapanca'da <strong>toplantı sonrası akşam yemeği</strong> için sakin bir adres arıyorsanız, gölün hemen yanındaki Mare Gastro bu ihtiyacı karşılıyor.",
 "body":[
  ("Toplantı Sonrası Neden Sakin Bir Mekan Tercih Edilmeli?",
   ["Bir toplantı ya da konferansın hemen ardından gidilecek mekan, günün geri kalanının nasıl hatırlanacağını belirler. Gürültülü ve kalabalık bir ortam yerine, sohbetin rahat aktığı sakin bir atmosfer; ekip içi ilişkileri güçlendirmek veya bir görüşmeyi olumlu bir notla kapatmak için daha uygun."]),
  ("Sapanca: Toplantıdan Sonra Kolay Ulaşılabilir Bir Rota",
   ["İstanbul'a yaklaşık 1,5 saat mesafede olan Sapanca, gün içinde yapılan bir toplantının ardından aynı akşam şehre dönmek isteyen ekipler için pratik bir rota. Şehrin trafiğinden ve gürültüsünden uzaklaşıp yine de geç saatlere kalmadan İstanbul'a dönebilirsiniz.",
    bfig("hero-mare-2.webp","Akşam ışıklarıyla Mare Gastro sofrası — Sapanca'da toplantı sonrası akşam yemeği","Mare Gastro'da bir akşam sofrası")]),
  ("Mare Gastro'da Toplantı Sonrası Akşam Nasıl Geçer?",
   ["Didi Otel bahçesindeki Mare Gastro, gölün hemen kıyısında sakin köşe masalarıyla toplantı sonrası bir akşam yemeği için doğal bir ortam sunuyor. %s ile devam eden bir sohbet, kurumsal bir günü keyifli bir notla kapatır."%L(STORY,"Zarif bir servis anlayışı")]),
  ("Rezervasyon ve Grup Planlaması",
   ["Toplantıya katılan ekip büyüklüğünü ve saatini önceden %s paylaşmanız, masa düzeninin ve servis akışının buna göre hazırlanmasını sağlar. %s güncel tabakları önceden inceleyebilirsiniz."%(L(REZ,"rezervasyon formundan"),L(MENU,"Menümüzden"))]),
 ],
 "faq":[
  ("Sapanca'da toplantı sonrası akşam yemeği için nereye gidilmeli?","Didi Otel bahçesindeki Mare Gastro, gölün hemen yanında sakin atmosferi ve fine dining mutfağıyla toplantı sonrası akşam yemeği için uygun bir adres."),
  ("İstanbul'daki bir toplantının ardından Sapanca'ya gidip aynı gün dönmek mümkün mü?","Evet. Sapanca, İstanbul'a yaklaşık 1,5 saat mesafede olduğundan gün içinde gidip akşam yemeğinin ardından dönmek mümkün."),
  ("Toplantı sonrası grup için özel masa ayrılabilir mi?","Evet, katılımcı sayısını rezervasyon sırasında belirttiğinizde gölün hemen yanındaki uygun bir masa ayarlanır."),
  ("Toplantı sonrası rezervasyon ne kadar önceden yapılmalı?","Özellikle hafta sonu akşamları için birkaç gün önceden rezervasyon yapılması önerilir."),
 ],
 "rel":["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-istanbula-yakin-sirket-etkinligi-mekani","sapanca-is-yemegi-kurumsal-davet"],
},
{
 "slug":"sapanca-istanbula-yakin-sirket-etkinligi-mekani",
 "cat":"kurumsal","date":"2026-09-08","read":"6 dk",
 "img":"mare-aerial.webp","alt":"Kuş bakışı göl ve bahçe manzarası — İstanbul'a yakın şirket etkinliği mekanı Mare Gastro",
 "h1":"İstanbul'a <em>Yakın</em> Şirket Etkinliği Mekanı: Neden Sapanca?",
 "title":"İstanbul'a Yakın Şirket Etkinliği Mekanı | Mare Gastro",
 "desc":"İstanbul'a yakın, şehir dışı hissi veren bir şirket etkinliği mekanı mı arıyorsunuz? Sapanca'daki Mare Gastro'yu ve avantajlarını keşfedin.",
 "kw":"istanbula yakın şirket etkinliği mekanı, istanbula yakın kurumsal organizasyon, sapanca şehir dışı şirket etkinliği, istanbuldan bir günde şirket yemeği",
 "lead":"İstanbul'un kalabalık toplantı salonlarından uzaklaşıp yine de aynı gün şehre dönebileceğiniz bir adres arıyorsanız, Sapanca tam bu ihtiyacı karşılıyor.",
 "body":[
  ("İstanbul İçindeki Şirket Etkinliği Mekanlarının Sınırları",
   ["İstanbul'da kurumsal etkinlikler genellikle ofis binalarının içindeki toplantı salonlarında ya da şehrin en çok bilinen birkaç adresinde tekrar tekrar düzenleniyor. Trafik, kalabalık ve tanıdık ofis atmosferinden çıkamama hissi; ekibe gerçek bir mola havası vermek isteyen şirketler için sınırlayıcı olabiliyor."]),
  ("Sapanca Neden İstanbul'a Yakın Bir Alternatif?",
   ["Sapanca, İstanbul'a yaklaşık 1,5 saat mesafede — bu da şehir dışına çıkıp aynı gün içinde dönmeyi mümkün kılıyor. Gölün ve doğanın sunduğu değişim, uzun bir yolculuk gerektirmeden ekibe gerçek bir atmosfer değişikliği yaşatıyor.",
    bfig("mare-teras-misafir2.webp","Gölün hemen yanında teras sofrası — İstanbul'a yakın şirket etkinliği Mare Gastro","Mare Gastro terasında bir kurumsal davet anı")]),
  ("Mare Gastro: Didi Otel Güvencesiyle Kurumsal Bir Adres",
   ["Mare Gastro, Sapanca'da kurulu, bilinen ve güvenilir bir otel işletmesi olan Didi Otel bünyesinde faaliyet gösteriyor; bu da etkinliğinizi amatör bir mekâna değil, kurumsal bir adrese emanet etmeniz anlamına geliyor. İsteyen ekipler, etkinlik sonrası %s da imkân buluyor."%L(SITE+"/tr/","Didi Otel'de konaklama yapma")]),
  ("Ne Tür Şirket Etkinlikleri İçin Uygun?",
   ["İstanbul'a yakın bir şehir dışı rota olarak Sapanca ve Mare Gastro, farklı kurumsal ihtiyaçlar için değerlendirilebilir:",
    "<ul><li>Ekip yemeği ve motivasyon akşamları</li><li>Bayi toplantısı sonrası davet</li><li>Yönetici kurulu akşam yemeği</li><li>Ödül gecesi veya başarı kutlaması</li><li>Kick-off ya da dönem kapanış yemeği</li></ul>"]),
  ("Planlama ve Rezervasyon",
   ["Etkinlik tarihini ve katılımcı sayısını %s önceden paylaşmanız, planlamanın sorunsuz ilerlemesini sağlar."%L(REZ,"rezervasyon formundan")]),
 ],
 "faq":[
  ("İstanbul'a yakın bir şirket etkinliği mekanı arıyorum, nereyi önerirsiniz?","Sapanca'daki Mare Gastro, İstanbul'a yaklaşık 1,5 saat mesafede olması, göl manzarası ve Didi Otel güvencesiyle şehir dışı şirket etkinlikleri için değerlendirilebilecek bir adres."),
  ("İstanbul'dan Sapanca'ya bir günde gidip dönmek mümkün mü?","Evet, Sapanca İstanbul'a yaklaşık 1,5 saat mesafededir; bu da aynı gün içinde etkinlik düzenleyip şehre dönmeyi mümkün kılar."),
  ("Şirket etkinliği sonrası Sapanca'da konaklanabilir mi?","Evet, Mare Gastro'nun bulunduğu Didi Otel bünyesinde isteyen ekipler için konaklama seçeneği mevcuttur."),
  ("Hangi tür şirket etkinlikleri için uygun?","Ekip yemeği, bayi toplantısı sonrası davet, yönetici kurulu akşam yemeği, ödül gecesi ve kick-off yemeği gibi farklı kurumsal ihtiyaçlar için değerlendirilebilir."),
 ],
 "rel":["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-toplu-organizasyon-grup-yemegi","sapanca-yil-sonu-sirket-yemegi-ve-kutlama"],
},
{
 "slug":"sapanca-toplu-organizasyon-grup-yemegi",
 "cat":"kurumsal","date":"2026-09-09","read":"6 dk",
 "img":"mare-grup-sofra.webp","alt":"Paylaşımlık grup sofrası — Sapanca'da toplu organizasyon ve şirket grup yemeği Mare Gastro",
 "h1":"Sapanca'da <em>Toplu Organizasyon</em> ve Grup Yemeği İçin Restoran Seçimi",
 "title":"Sapanca'da Toplu Organizasyon ve Grup Yemeği | Mare Gastro",
 "desc":"Sapanca'da toplu organizasyon veya kalabalık şirket grubu için yemek planlıyorsanız, kapasiteden menüye dikkat edilmesi gerekenleri ve Mare Gastro'yu keşfedin.",
 "kw":"sapanca toplu organizasyon, sapanca grup yemeği, sapanca kalabalık şirket grubu, sapanca toplu yemek organizasyonu, sapanca grup rezervasyonu restoran",
 "lead":"Kalabalık bir ekip ya da bayi grubu için toplu bir organizasyon planlarken, mekan seçimi büyüklüğü kadar kalitesini de korumalı.",
 "body":[
  ("Toplu Organizasyonlarda Mekan Seçimi Neden Zor?",
   ["Kalabalık bir grup söz konusu olduğunda, pek çok mekan servis kalitesinden ödün veriyor; menü standart bir banket formatına indirgeniyor ve her masa aynı özeni görmüyor. <strong>Sapanca'da toplu organizasyon</strong> planlarken bu riski göz önünde bulundurmak, günün kalitesini doğrudan etkiler."]),
  ("Mare Gastro'da Grup Büyüklüğüne Göre Planlama",
   ["Grup büyüklüğünüzü %s paylaştığınızda, ekibimiz Didi Otel bahçesinde en uygun oturma düzenini sizin için hazırlar. Küçük bir ekip yemeğinden kalabalık bir bayi organizasyonuna kadar farklı ölçekte gruplar ağırlanıyor.",
    bfig("hero-mare-3.webp","Gölün hemen yanında geniş bahçe sofrası — Sapanca'da toplu organizasyon Mare Gastro","Mare Gastro'da bir grup organizasyonu")]),
  ("Paylaşımlık Menü ile Toplu Organizasyonlarda Kalite Kaybı Yaşanmaz",
   ["Deniz ürünleri ağırlıklı paylaşımlık tabaklar, kalabalık bir masada herkesin aynı özenle hazırlanmış lezzetleri tadabilmesine imkân tanır. %s grup için uygun seçenekleri önceden inceleyebilirsiniz."%L(MENU,"Menümüzden")]),
  ...
  ("Rezervasyon Önerileri",
   ["Toplu organizasyonlar için kişi sayısını ve tarihi %s en az birkaç gün önceden paylaşmanız, servis akışının sorunsuz ilerlemesini sağlar."%L(WA,"WhatsApp üzerinden")]),
 ],
 "faq":[
  ("Sapanca'da toplu organizasyon için uygun bir restoran var mı?","Evet. Mare Gastro, Didi Otel bahçesinde farklı büyüklükte grupları ağırlayacak esnek masa düzenleri ve paylaşımlık menü seçenekleri sunar."),
  ("Kalabalık gruplarda servis kalitesi düşer mi?","Mare Gastro'da grup büyüklüğü fark etmeksizin aynı fine dining özeni korunur; menü paylaşımlık tabaklarla bu ölçeğe uyarlanır."),
  ("Toplu organizasyon için kaç kişilik gruplara hizmet veriliyor?","Grup büyüklüğüne göre masa ve servis düzeni önceden planlanır; kalabalık organizasyonlar için erken bilgi verilmesi önerilir."),
  ("Toplu organizasyon için otopark yeterli mi?","Evet, Didi Otel bünyesinde geniş otopark imkânı bulunur."),
 ],
 "rel":["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-kalabalik-arkadas-grubu-dogum-gunu","sapanca-is-yemegi-kurumsal-davet"],
},
{
 "slug":"sapanca-yil-sonu-sirket-yemegi-ve-kutlama",
 "cat":"kurumsal","date":"2026-09-10","read":"6 dk",
 "img":"mare-gece-terasi.webp","alt":"Gece ışıklarıyla aydınlanan teras — Sapanca'da yıl sonu şirket yemeği ve kurumsal kutlama Mare Gastro",
 "h1":"Sapanca'da <em>Yıl Sonu Şirket Yemeği</em> ve Kurumsal Kutlama İçin Bir Adres",
 "title":"Sapanca'da Yıl Sonu Şirket Yemeği | Mare Gastro",
 "desc":"Yıl sonu şirket yemeği veya kurumsal kutlama için Sapanca'da göl manzaralı, canlı müzik eşliğinde zarif bir adres arıyorsanız Mare Gastro'yu keşfedin.",
 "kw":"sapanca yıl sonu şirket yemeği, sapanca kurumsal kutlama, yıl sonu kurumsal yemek sapanca, şirket yılbaşı yemeği sapanca, sapanca ödül gecesi mekanı",
 "lead":"Yılın kapanışını kutlamak, ekibe teşekkür etmek ya da bir başarıyı taçlandırmak için doğru sofra, o anın değerini artırır.",
 "body":[
  ("Yıl Sonu Şirket Yemeği İçin Neden Farklı Bir Mekan Tercih Edilmeli?",
   ["Yılın en yoğun döneminin ardından ekibi her zamanki ofis ortamından veya sık gidilen bir şehir restoranından çıkarmak, kutlamayı gerçek bir anıya dönüştürür. <strong>Sapanca'da yıl sonu şirket yemeği</strong> arayan ekipler, bu değişimi göl kenarında bir akşamla yaşıyor."]),
  ("Mare Gastro'da Yıl Sonu Kutlaması Nasıl Geçer?",
   ["Didi Otel bahçesindeki Mare Gastro'da hafta sonu akşamlarına genellikle canlı müzik eşlik ediyor; gölün üzerine yansıyan ışıklandırma ile birleşen bu atmosfer, yıl sonu kutlamalarını sıradan bir akşam yemeğinden ayırıyor.",
    bfig("mare-bahce-havuz-yolu.webp","Didi Otel bahçesinden akşam yürüyüş yolu — Sapanca'da yıl sonu şirket kutlaması","Didi Otel bahçesinde akşam atmosferi")]),
  ("Ödül Gecesi, Kick-off Yemeği veya Bayi Toplantısı Kutlaması",
   ["Yıl sonu döneminde şirketlerin planladığı kutlamalar farklı isimler taşısa da benzer bir atmosfer arıyor: ödül gecesi, yıl sonu değerlendirme yemeği, kick-off akşamı veya bayi toplantısı kapanış daveti. Mare Gastro, bu kutlamaların her biri için gölün hemen yanında sakin ve zarif bir sofra sunuyor."]),
  ("Menü ve Kutlama Detayları Nasıl Planlanır?",
   ["%s inceleyerek ekibinize uygun tabakları önceden belirleyebilir, %s üzerinden katılımcı sayısı ve tarih bilgisini paylaşarak günü birlikte planlayabilirsiniz."%(L(MENU,"Menümüzü"),L(REZ,"rezervasyon formu"))]),
  ("Rezervasyon İçin Ne Zaman Başvurmalı?",
   ["Yıl sonu döneminde hafta sonu masaları hızla doluyor; erken rezervasyon, tercih ettiğiniz tarih ve saati garantilemenin en güvenli yolu."]),
 ],
 "faq":[
  ("Sapanca'da yıl sonu şirket yemeği için nereye gidilmeli?","Didi Otel bahçesindeki Mare Gastro, göl manzarası, hafta sonu canlı müzik atmosferi ve fine dining mutfağıyla yıl sonu kurumsal kutlamalar için uygun bir adres."),
  ("Ödül gecesi veya kick-off yemeği için uygun mu?","Evet. Farklı büyüklükte gruplar için oturma düzeni ve menü, etkinliğin niteliğine göre önceden planlanır."),
  ("Yıl sonu için ne zaman rezervasyon yapılmalı?","Yıl sonu döneminde talep arttığından, özellikle hafta sonu tarihleri için mümkün olduğunca erken rezervasyon yapılması önerilir."),
  ("Yıl sonu kutlamasında canlı müzik oluyor mu?","Mare Gastro'da hafta sonu akşamlarına genellikle canlı müzik eşlik ediyor; bu atmosfer yıl sonu kutlamalarını da kapsıyor."),
 ],
 "rel":["sapanca-yilbasi-yemegi","sapanca-istanbula-yakin-sirket-etkinligi-mekani","sapanca-kurumsal-etkinlik-en-iyi-mekanlar"],
},
{
 ...
 "title":"Sapanca'da Vejetaryen Restoran | Mare Gastro",
...
},
{
 ...
 "title":"Sapanca'da Doğum Günü Pastası ve Süsleme | Mare Gastro",
 "desc":"Sapanca'da doğum günü pastası ve masa süslemesi sunan restoran mı arıyorsunuz? Mare Gastro'da rezervasyon sırasında talep ederek özel sofra hazırlatabilirsiniz.",
...
},
{
 ...
 "desc":"İstanbul'dan yaklaşık 1,5 saat mesafedeki Sapanca'da doğum günü kaçamağı planlıyorsanız Mare Gastro, kolay ulaşım ve konaklama seçeneğiyle ideal bir adres.",
...
},
{
 ...
 "desc":"Sapanca'da doğum günü kutlamak için en iyi 5 mekanı karşılaştırdık: göl manzarası, atmosfer ve kutlamaya uygunluk açısından Mare Gastro ve diğer adresler.",
...
},
{
 ...
 "desc":"Vesilesiz, sadece keyifli bir akşam için Sapanca'da arkadaşlarla buluşulacak en iyi mekan nasıl seçilir? Göl manzarası, uzun sofra ve canlı müzik rehberi.",
...
},
{
 ...
 "desc":"Sapanca'nın en iyi restoranını ararken göl manzarası, mutfak kalitesi ve atmosfer neye göre karşılaştırılır? Mare Gastro ve diğer adresleri inceledik.",
...
},
{
 ...
 "desc":"Mare Gastro nasıl doğdu? Didi Otel bahçesinde, Şef Doğan Anapa imzasıyla şekillenen Ege-Akdeniz mutfağı ve gölün hemen yanındaki fine dining felsefesi.",
...
},
{
 ...
 "desc":"Sapanca'da köpeğiniz veya kedinizle gidebileceğiniz evcil hayvan dostu bir restoran mı arıyorsunuz? Mare Gastro, geniş açık bahçesiyle dostlarınızı ağırlıyor.",
...
},
{
 ...
 "desc":"Sapanca'da araçla gidip park sorunu yaşamadan yemek yemek istiyorsanız Mare Gastro, vale hizmeti ve ücretsiz otoparkla konforlu bir varış sunuyor.",
...
},
{
 ...
 "title":"İstanbul'a Yakın Evlilik Teklifi: En İyi 5 | Mare Gastro",
 "desc":"İstanbul'a yakın, unutulmaz bir evlilik teklifi için en iyi 5 mekanı karşılaştırdık: mahremiyet, göl manzarası ve sürpriz organizasyonu açısından inceledik.",
...
},
{
 ...
 "title":"İstanbul'a Yakın Lüks Doğum Günü Mekanı | Mare Gastro",
 "desc":"İstanbul'a yakın, lüks bir doğum günü kutlaması için en iyi 5 mekanı karşılaştırdık: ulaşım, fine dining seviyesi ve kutlama hizmeti açısından inceledik.",
...
},
{
 ...
 "title":"Sapanca'da Lüks Doğum Günü Mekanı | Mare Gastro",
 "desc":"Sapanca'da doğum gününüzü lüks bir mekanda kutlamak istiyorsanız öne çıkan öneriler: fine dining standardı, servis kalitesi ve atmosfer açısından Mare Gastro.",
...
},
{
 ...
 "title":"Sapanca'da Yıldönümü İçin En İyi 5 Mekan | Mare Gastro",
 "desc":"Sapanca'da yıldönümü kutlamak için en iyi 5 mekanı karşılaştırdık: göl manzarası, romantik atmosfer ve sürpriz organizasyonu açısından Mare Gastro ve diğerleri.",
...
},
{
 ...
 "title":"Eşinizle Sapanca'da Özel Bir Akşam | Mare Gastro",
 "desc":"Belirli bir tarih olmadan eşinizle Sapanca'da özel bir akşam geçirmek istiyorsanız öne çıkan mekanlar: sakin atmosfer ve göl manzarası açısından Mare Gastro.",
