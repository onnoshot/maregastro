...
CATS = {
 ...
 "sosyal":{"en":"Social","ar":"اجتماعي","ru":"Общение"},
 "hikaye":{"en":"Our Story","ar":"قصتنا","ru":"Наша история"},
 "vejetaryen":{"en":"Vegetarian","ar":"نباتي","ru":"Вегетарианское"},
 "manzara":{"en":"Lake View","ar":"إطلالة البحيرة","ru":"Вид на озеро"},
 "sef":{"en":"Our Chef","ar":"شيفنا","ru":"Наш шеф-повар"},
 "didi":{"en":"Didi Otel","ar":"Didi Otel","ru":"Didi Otel"},
 "kahvalti":{"en":"Breakfast","ar":"الإفطار","ru":"Завтрак"},
 "mevsim":{"en":"Season","ar":"الموسم","ru":"Сезон"},
 "raki":{"en":"Rakı & Fish","ar":"راكي وسمك","ru":"Раки и рыба"},
 "gece":{"en":"Open Late","ar":"مفتوح ليلًا","ru":"Открыто допоздна"},
}
...
REL_MAP = {
 ...
 "sef-dogan-anapa": ["sapanca-fine-dining-nedir","sef-dogan-anapa-kimdir","sapanca-deniz-urunleri"],
 "sapanca-romantik-aksam-yemegi": ["sapanca-luks-restoran","didi-otel-restoran","sapanca-fine-dining-nedir"],
 "sapancada-ne-yenir": ["sapanca-deniz-urunleri","sapanca-luks-restoran","istanbula-yakin-luks-restoran"],
 "didi-otel-restoran": ["sapanca-luks-restoran","sapanca-romantik-aksam-yemegi","sapanca-fine-dining-nedir"],
 "istanbula-yakin-luks-restoran": ["sapanca-luks-restoran","sapancada-ne-yenir","didi-otel-restoran"],
 "sapanca-evlilik-teklifi": ["sapanca-romantik-aksam-yemegi","sapanca-yildonumu-yemegi","didi-otel-restoran"],
 "sapanca-yildonumu-yemegi": ["sapanca-ozel-gun-kutlama","sapanca-dogum-gunu-nerede-kutlanir","sapanca-romantik-aksam-yemegi"],
 "sapanca-gol-manzarali-kahvalti": ["didi-otel-restoran","sapancada-ne-yenir","sapanca-gun-batimi-restoran"],
 "sapanca-kis-restoran": ["sapanca-yilbasi-yemegi","sapanca-yazin-acik-hava-restoran","sapanca-luks-restoran"],
 "sapanca-yilbasi-yemegi": ["sapanca-kis-restoran","sapanca-romantik-aksam-yemegi","sapanca-luks-restoran"],
 "sapanca-raki-balik": ["sapanca-deniz-urunleri","sapanca-gece-acik-restoran","sapancada-ne-yenir"],
 "sapanca-gece-acik-restoran": ["sapanca-raki-balik","sapanca-deniz-urunleri","didi-otel-restoran"],
 "sapanca-ozel-gun-kutlama": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-yildonumu-yemegi","sapanca-evlilik-teklifi"],
 "sef-dogan-anapa-kimdir": ["sef-dogan-anapa","sapanca-fine-dining-nedir","sapanca-deniz-urunleri"],
 "sapanca-yazin-acik-hava-restoran": ["sapanca-kis-restoran","sapanca-gun-batimi-restoran","sapanca-gol-manzarali-kahvalti"],
 "sapanca-fine-dining-fiyat-rehberi": ["sapanca-fine-dining-nedir","sapanca-luks-restoran","istanbula-yakin-luks-restoran"],
 "sapanca-is-yemegi-kurumsal-davet": ["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-toplu-organizasyon-grup-yemegi","sapanca-istanbula-yakin-sirket-etkinligi-mekani"],
 "sapanca-toplanti-sonrasi-aksam-yemegi": ["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-istanbula-yakin-sirket-etkinligi-mekani","sapanca-is-yemegi-kurumsal-davet"],
 "sapanca-toplu-organizasyon-grup-yemegi": ["sapanca-kurumsal-etkinlik-en-iyi-mekanlar","sapanca-kalabalik-arkadas-grubu-dogum-gunu","sapanca-is-yemegi-kurumsal-davet"],
 "sapanca-yil-sonu-sirket-yemegi-ve-kutlama": ["sapanca-yilbasi-yemegi","sapanca-istanbula-yakin-sirket-etkinligi-mekani","sapanca-kurumsal-etkinlik-en-iyi-mekanlar"],
 "sapanca-vejetaryen-restoran": ["sapanca-deniz-urunleri","sapanca-fine-dining-nedir","sapanca-luks-restoran"],
 "sapanca-dogum-gunu-nerede-kutlanir": ["sapanca-ozel-gun-kutlama","sapanca-suprizli-dogum-gunu-organizasyonu","sapanca-gol-manzarali-dogum-gunu-mekanlari"],
 "sapanca-suprizli-dogum-gunu-organizasyonu": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-dogum-gunu-pastasi-suslemeli-mekan","sapanca-ozel-gun-kutlama"],
 "sapanca-gol-manzarali-dogum-gunu-mekanlari": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-gun-batimi-restoran","sapanca-romantik-es-dogum-gunu-yemegi"],
 "sapanca-kalabalik-arkadas-grubu-dogum-gunu": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-istanbuldan-dogum-gunu-kacamagi","sapanca-is-yemegi-kurumsal-davet"],
 "sapanca-arkadaslarla-bulusma-mekani": ["sapanca-kalabalik-arkadas-grubu-dogum-gunu","sapanca-gece-acik-restoran","sapanca-hafta-sonu-rotasi"],
 "sapanca-dogum-gunu-luks-mekan-onerileri": ["sapanca-luks-restoran","sapanca-en-iyi-dogum-gunu-mekanlari","sapanca-vale-otopark-restoran"],
 "sapanca-romantik-es-dogum-gunu-yemegi": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-romantik-aksam-yemegi","sapanca-evlilik-teklifi"],
 "sapanca-dogum-gunu-pastasi-suslemeli-mekan": ["sapanca-suprizli-dogum-gunu-organizasyonu","sapanca-dogum-gunu-nerede-kutlanir","sapanca-yildonumu-yemegi"],
 "sapanca-gece-dogum-gunu-kutlamasi-hafta-sonu": ["sapanca-gece-acik-restoran","sapanca-dogum-gunu-nerede-kutlanir","sapanca-gol-manzarali-dogum-gunu-mekanlari"],
 "sapanca-30-40-yas-dogum-gunu-kutlamasi": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-kalabalik-arkadas-grubu-dogum-gunu","sapanca-dogum-gunu-pastasi-suslemeli-mekan"],
 "sapanca-istanbuldan-dogum-gunu-kacamagi": ["sapanca-dogum-gunu-nerede-kutlanir","istanbula-yakin-luks-restoran","sapanca-hafta-sonu-rotasi"],
 "sapanca-dogum-gunu-fiyatlari-ve-menu-secenekleri": ["sapanca-dogum-gunu-nerede-kutlanir","sapanca-fine-dining-fiyat-rehberi","sapanca-30-40-yas-dogum-gunu-kutlamasi"],
 "sapanca-sevgililer-gunu-yemegi": ["sapanca-romantik-aksam-yemegi","sapanca-evlilik-teklifi","sapanca-yildonumu-yemegi"],
 "sapanca-nisan-yemegi": ["sapanca-evlilik-teklifi","sapanca-kalabalik-arkadas-grubu-dogum-gunu","sapanca-yildonumu-yemegi"],
 "sapanca-evcil-hayvan-dostu-restoran": ["sapanca-yazin-acik-hava-restoran","sapanca-hafta-sonu-rotasi","sapancada-ne-yenir"],
 "sapanca-vale-otopark-restoran": ["sapancaya-nasil-gidilir","sapanca-hafta-sonu-rotasi","sapanca-gece-acik-restoran"],
 "sapanca-esinizle-ozel-aksam": ["sapanca-romantik-aksam-yemegi","sapanca-yildonumu-icin-en-iyi-mekan","didi-otel-restoran"],
 "mare-gastro-hikayesi": ["sef-dogan-anapa-kimdir","sef-dogan-anapa","didi-otel-restoran"],
 "mare-gastro-dijital-donusum-hikayesi": ["mare-gastro-hikayesi","sef-dogan-anapa-kimdir","didi-otel-restoran"],
 "sapanca-gun-batimi-restoran": ["sapanca-romantik-aksam-yemegi","sapanca-gol-manzarali-kahvalti","sapancada-ne-yenir"],
}
